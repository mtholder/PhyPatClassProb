...
The use of $+=$ here is a reminder that the calculations must be summed over this scenario and another in which the repeated state is found in the right subtree.
